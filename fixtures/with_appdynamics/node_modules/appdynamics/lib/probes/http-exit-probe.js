...
HttpExitProbe.prototype.attach = function(obj, moduleName) {
    ...
    if(exitCall) {
      if(locals.res) {
        ...
        if((!error) && ((exitCall.statusCode < 200) || (exitCall.statusCode >= 400))) {
          error = {message: "Error code " + exitCall.statusCode + " for URL " + locals.opts.hostname + ":" + locals.opts.port + locals.opts.path,
            name: "Error",
  ...
  proxy.around(obj, 'request', function(obj, args, locals) {
    ...
    if (!args[0].appdIgnore && !isDynamoDBReq && !isRepeatForHttps) { // (ignore internal HTTP calls, e.g. to Analytics Agent, DynamoDB calls)
